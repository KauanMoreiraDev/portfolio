...
export default function SlideProjects() {
    ...
    const { current, nextSlide, prevSlide } = useSlider();
    ...
    const acessFigma = ( link: string | URL | undefined ) => {
        window.open(link, "_blank");
    }

    return (
        <div className={`relative mx-auto overflow-hidden w-full h-full rounded-3xl shadow-xl`}>
                            ...
                            <div className="flex flex-col w-full sm:w-1/2 h-full p-3">
                                ...
                                <div className="w-full h-1/6 py-2">
                                    <div className="flex flex-row justify-start">
                                        <div className="nextJs w-1/6 h-8 ">
                                        ...
                                        <div className="typescript w-1/6 h-8">
                                        ...
                                        <div className="tailwindCss w-1/6 h-8 ">
                                        ...
                                        <div className="figma w-1/6 h-8">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="90%" viewBox="0 0 256 384"><path fill="#840090" d="M64 384c35.328 0 64-28.672 64-64v-64H64c-35.328 0-64 28.672-64 64s28.672 64 64 64" /><path fill="#840090" d="M0 192c0-35.328 28.672-64 64-64h64v128H64c-35.328 0-64-28.672-64-64" /><path fill="#840090" d="M0 64C0 28.672 28.672 0 64 0h64v128H64C28.672 128 0 99.328 0 64" /><path fill="#840090" d="M128 0h64c35.328 0 64 28.672 64 64s-28.672 64-64 64h-64z" /><path fill="#840090" d="M256 192c0 35.328-28.672 64-64 64s-64-28.672-64-64s28.672-64 64-64s64 28.672 64 64" /></svg>
                                        </div>
                                    </div>
                                </div>
